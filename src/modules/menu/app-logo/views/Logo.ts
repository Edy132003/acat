...
export class Logo extends CustomElement {
	...
	<!-- Left Side Whiskers -->
	<line x1="60" y1="115" x2="80" y2="112" stroke="black" stroke-width="2" />
	<line x1="60" y1="120" x2="80" y2="117" stroke="black" stroke-width="2" />
	<line x1="60" y1="125" x2="80" y2="122" stroke="black" stroke-width="2" />

	<!-- Right Side Whiskers -->
	<line x1="140" y1="115" x2="120" y2="112" stroke="black" stroke-width="2" />
	<line x1="140" y1="120" x2="120" y2="117" stroke="black" stroke-width="2" />
	<line x1="140" y1="125" x2="120" y2="122" stroke="black" stroke-width="2" />
    </svg>`;
    }
}
